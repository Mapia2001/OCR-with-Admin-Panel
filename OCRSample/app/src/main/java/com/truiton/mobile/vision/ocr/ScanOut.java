...
public class ScanOut extends AppCompatActivity {
    ...
    public static boolean isscanoutyes = false;
    public static boolean isscanoutno = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestPermissions();
        detectedTextView = (TextView) findViewById(R.id.scanoutscanresult);
        detectedTextView.setMovementMethod(new ScrollingMovementMethod());
        findViewById(R.id.scanoutout).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        findViewById(R.id.scanoutyes).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if ( isscanoutyes ){
                    if ( countsave < 1 && captureorder == 5 ){
                        isbutton = "Y";
                        if ( ((CheckBox)findViewById(R.id.scanoutloadstatus)).isChecked() ){
                            isempty = "Y";
                        }else{
                            isempty = "N";
                        }
                        ScanOut.SaveScan save = new ScanOut.SaveScan(userid,companyname,regno,trailerno,containerno,isocode,sealno,isempty,isbutton);
                        save.execute();
                        captureorder = 0;
                        thirdindex = 0;
        ...
        findViewById(R.id.scanoutno).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                detectedTextView.setText("");
                captureorder = 0;
